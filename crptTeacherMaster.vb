...
Public Class crptTeacherMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Admission_System.crptTeacherMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptTeacherMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptTeacherMaster = New crptTeacherMaster
        rpt.Site = Me.Site
        Return rpt
    End Function
