...
Public Class crptEnquiry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Admission_System.crptEnquiry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptEnquiry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptEnquiry = New crptEnquiry
        rpt.Site = Me.Site
        Return rpt
    End Function
