...
Public Class crptAdmission
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Admission_System.crptAdmission.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptAdmission
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptAdmission = New crptAdmission
        rpt.Site = Me.Site
        Return rpt
    End Function
