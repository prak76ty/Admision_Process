...
Public Class rptExamStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Admission_System.rptExamStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExamStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExamStatement = New rptExamStatement
        rpt.Site = Me.Site
        Return rpt
    End Function
