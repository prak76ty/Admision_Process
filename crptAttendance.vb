...
Public Class crptAttendance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_Admission_System.crptAttendance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptAttendance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptAttendance = New crptAttendance
        rpt.Site = Me.Site
        Return rpt
    End Function
